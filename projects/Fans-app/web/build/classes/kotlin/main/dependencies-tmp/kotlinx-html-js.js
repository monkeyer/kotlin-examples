(function (root, factory) {
  ...
  function _isLetter($receiver) {
    return letterRangeLowerCase.contains_mef7kx$(unboxChar($receiver)) || letterRangeUpperCase.contains_mef7kx$(unboxChar($receiver));
  }
  function _isDigit($receiver) {
    return digitRange.contains_mef7kx$(unboxChar($receiver));
  }
  ...
  function isValidXmlAttributeName($receiver) {
    ...
    var tmp$_0 = tmp$ && (_isLetter(unboxChar($receiver.charCodeAt(0))) || unboxChar($receiver.charCodeAt(0)) === 95);
    if (tmp$_0) {
      var all$result;
      all$break: do {
        var tmp$_1;
  ...
  function escapeAppend($receiver, s) {
    ...
    for (var idx = 0; idx <= tmp$; idx++) {
      var ch = unboxChar(s.charCodeAt(idx));
      var escape = escapeMap.get_11rb$(toBoxedChar(ch));
      if (escape != null) {
