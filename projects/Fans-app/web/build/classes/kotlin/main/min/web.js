(function (_, Kotlin, $module$kotlinx_serialization_runtime_js, $module$common_js, $module$kotlin_react_dom, $module$kotlin_extensions, $module$kotlin_react, $module$react_router_dom) {
  ...
  Coroutine$fetchAll_0.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$fetchSessions.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$fetchSession_61zpoe$.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  SessionsAPI$subscribeToVotes$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: [VotesSubscription]};
  ...
  SessionsAPI.$metadata$ = {kind: Kind_CLASS, simpleName: 'SessionsAPI', interfaces: []};
  function VotesSubscription() {
  }
  VotesSubscription.$metadata$ = {kind: Kind_INTERFACE, simpleName: 'VotesSubscription', interfaces: []};
  ...
  Object.defineProperty(async$lambda$ObjectLiteral.prototype, 'context', {get: function () {
  ...
  async$lambda$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: [Continuation]};
  ...
  SessionComponent.prototype.renderSessionBlock_0 = function ($receiver, session) {
    ...
    while (tmp$.hasNext()) {
      var tmp$_0 = tmp$.next();
      var index = tmp$_0.component1(), speaker = tmp$_0.component2();
      if (index > 0) {
  ...
  Coroutine$SessionComponent$loadData$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  SessionComponent.$metadata$ = {kind: Kind_CLASS, simpleName: 'SessionComponent', interfaces: [RComponent]};
  ...
  Coroutine$SessionsComponent$loadData$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  SessionsComponent.$metadata$ = {kind: Kind_CLASS, simpleName: 'SessionsComponent', interfaces: [RComponent]};
  ...
  function dateRange_0($receiver, range) {
    var startsAt = range.component1(), endsAt = range.component2();
