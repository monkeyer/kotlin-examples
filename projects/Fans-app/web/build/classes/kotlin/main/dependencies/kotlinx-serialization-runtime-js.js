(function (root, factory) {
  ...
  LinkedHashMapSerializer.prototype = Object.create(ListLikeSerializer.prototype);
  LinkedHashMapSerializer.prototype.constructor = LinkedHashMapSerializer;
  HashMapSerializer.prototype = Object.create(ListLikeSerializer.prototype);
  ...
  function ByteOrder$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant kotlinx.io.ByteOrder.' + name);
    }
  }
  ...
  SerialContext.prototype.getSerializerByValue_issdgt$ = function (value) {
    var tmp$;
    if (value == null)
      throw new SerializationException('Cannot determine class for value ' + Kotlin.toString(value));
    var t = value;
  ...
  SerialContext.prototype.getSerializer_30y1fr$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.SerialContext.getSerializer_30y1fr$', function (T_0, isT) {
    return this.getSerializerByClass_lmshww$(Kotlin.getKClass(T_0));
  });
  ...
  function Serializable(with_0) {
    if (with_0 === void 0)
      with_0 = Kotlin.getKClass(KSerializer);
    this.with = with_0;
  }
  ...
  ValueTransformer.prototype.transform_nleje8$ = function (serializer, obj) {
    ...
    return input.read_2wvhm6$(serializer);
  };
  ValueTransformer.prototype.transform_issdgt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.ValueTransformer.transform_issdgt$', wrapFunction(function () {
    var serializer = _.kotlinx.serialization.serializer_1yb8b7$;
    return function (T_0, isT, obj) {
      return this.transform_nleje8$(serializer(Kotlin.getKClass(T_0)), obj);
    };
  }));
  ...
  ValueTransformer$Input.prototype.readValue = function () {
    var tmp$, tmp$_0;
    return (tmp$_0 = this.list_0.get_za3lpa$((tmp$ = this.index_0, this.index_0 = tmp$ + 1 | 0, tmp$))) != null ? tmp$_0 : Kotlin.throwNPE();
  };
  ...
  ValueTransformer$Input.prototype.readBooleanValue = function () {
    ...
    tmp$_0 = (tmp$ = this.curDesc_0) != null ? tmp$ : Kotlin.throwNPE();
    tmp$_1 = this.curIndex_0;
    tmp$_3 = typeof (tmp$_2 = this.readValue()) === 'boolean' ? tmp$_2 : Kotlin.throwCCE();
    return this.$outer.transformBooleanValue_gw9ugo$(tmp$_0, tmp$_1, tmp$_3);
  };
  ValueTransformer$Input.prototype.readByteValue = function () {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3;
    tmp$_0 = (tmp$ = this.curDesc_0) != null ? tmp$ : Kotlin.throwNPE();
    tmp$_1 = this.curIndex_0;
    tmp$_3 = typeof (tmp$_2 = this.readValue()) === 'number' ? tmp$_2 : Kotlin.throwCCE();
    return this.$outer.transformByteValue_sdbpl4$(tmp$_0, tmp$_1, tmp$_3);
  };
  ValueTransformer$Input.prototype.readShortValue = function () {
    ...
    tmp$_1 = this.curIndex_0;
    tmp$_3 = typeof (tmp$_2 = this.readValue()) === 'number' ? tmp$_2 : Kotlin.throwCCE();
    return this.$outer.transformShortValue_quoth0$(tmp$_0, tmp$_1, tmp$_3);
  };
  ValueTransformer$Input.prototype.readIntValue = function () {
    ...
    tmp$_1 = this.curIndex_0;
    tmp$_3 = typeof (tmp$_2 = this.readValue()) === 'number' ? tmp$_2 : Kotlin.throwCCE();
    return this.$outer.transformIntValue_j8ubi9$(tmp$_0, tmp$_1, tmp$_3);
  };
  ValueTransformer$Input.prototype.readLongValue = function () {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3;
    tmp$_0 = (tmp$ = this.curDesc_0) != null ? tmp$ : Kotlin.throwNPE();
    tmp$_1 = this.curIndex_0;
    tmp$_3 = Kotlin.isType(tmp$_2 = this.readValue(), Kotlin.Long) ? tmp$_2 : Kotlin.throwCCE();
    return this.$outer.transformLongValue_sd5j9w$(tmp$_0, tmp$_1, tmp$_3);
  };
  ValueTransformer$Input.prototype.readFloatValue = function () {
    ...
    tmp$_1 = this.curIndex_0;
    tmp$_3 = typeof (tmp$_2 = this.readValue()) === 'number' ? tmp$_2 : Kotlin.throwCCE();
    return this.$outer.transformFloatValue_r1rln8$(tmp$_0, tmp$_1, tmp$_3);
  };
  ValueTransformer$Input.prototype.readDoubleValue = function () {
    ...
    tmp$_1 = this.curIndex_0;
    tmp$_3 = typeof (tmp$_2 = this.readValue()) === 'number' ? tmp$_2 : Kotlin.throwCCE();
    return this.$outer.transformDoubleValue_cy908x$(tmp$_0, tmp$_1, tmp$_3);
  };
  ValueTransformer$Input.prototype.readCharValue = function () {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3;
    tmp$_0 = (tmp$ = this.curDesc_0) != null ? tmp$ : Kotlin.throwNPE();
    tmp$_1 = this.curIndex_0;
    tmp$_3 = unboxChar(Kotlin.isChar(tmp$_2 = this.readValue()) ? tmp$_2 : Kotlin.throwCCE());
    return this.$outer.transformCharValue_sdbfne$(tmp$_0, tmp$_1, tmp$_3);
  };
  ValueTransformer$Input.prototype.readStringValue = function () {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3;
    tmp$_0 = (tmp$ = this.curDesc_0) != null ? tmp$ : Kotlin.throwNPE();
    tmp$_1 = this.curIndex_0;
    tmp$_3 = typeof (tmp$_2 = this.readValue()) === 'string' ? tmp$_2 : Kotlin.throwCCE();
    return this.$outer.transformStringValue_k4mjep$(tmp$_0, tmp$_1, tmp$_3);
  };
  ValueTransformer$Input.prototype.readEnumValue_xvqrpl$ = function (enumClass) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3;
    tmp$_0 = (tmp$ = this.curDesc_0) != null ? tmp$ : Kotlin.throwNPE();
    tmp$_1 = this.curIndex_0;
    tmp$_3 = Kotlin.isType(tmp$_2 = this.readValue(), Enum) ? tmp$_2 : Kotlin.throwCCE();
    return this.$outer.transformEnumValue_bta54i$(tmp$_0, tmp$_1, enumClass, tmp$_3);
  };
  ValueTransformer$Input.prototype.readSerializableValue_2wvhm6$ = function (loader) {
    var tmp$;
    if (this.$outer.isRecursiveTransform())
      return loader.load_ljkqvg$(this);
    else
      return (tmp$ = this.readValue()) == null || Kotlin.isType(tmp$, Any) ? tmp$ : Kotlin.throwCCE();
  };
  ...
  ValueTransformer$Input.prototype.readSerializableElementValue_ovkjkf$ = function (desc, index, loader) {
    this.cur_0(desc, index);
    return this.readSerializableValue_2wvhm6$(loader);
  };
  ValueTransformer$Input.prototype.readNullableSerializableElementValue_3ohjxu$ = function (desc, index, loader) {
    this.cur_0(desc, index);
    return this.readNullableSerializableValue_xg8iph$(loader);
  };
  ...
  function TaggedOutput() {
    KOutput.call(this);
    this.tagStack_m19g9s$_0 = ArrayList_init();
  }
  ...
  function TaggedInput() {
    KInput.call(this);
    this.tagStack_56p8av$_0 = ArrayList_init();
  ...
  TaggedInput.prototype.readTaggedUnit_11rb$ = function (tag) {
    var tmp$;
    Kotlin.isType(tmp$ = this.readTaggedValue_11rb$(tag), Object.getPrototypeOf(kotlin.Unit).constructor) ? tmp$ : Kotlin.throwCCE();
  };
  TaggedInput.prototype.readTaggedBoolean_11rb$ = function (tag) {
    var tmp$;
    return typeof (tmp$ = this.readTaggedValue_11rb$(tag)) === 'boolean' ? tmp$ : Kotlin.throwCCE();
  };
  TaggedInput.prototype.readTaggedByte_11rb$ = function (tag) {
    var tmp$;
    return typeof (tmp$ = this.readTaggedValue_11rb$(tag)) === 'number' ? tmp$ : Kotlin.throwCCE();
  };
  ...
  TaggedInput.prototype.readTaggedLong_11rb$ = function (tag) {
    var tmp$;
    return Kotlin.isType(tmp$ = this.readTaggedValue_11rb$(tag), Kotlin.Long) ? tmp$ : Kotlin.throwCCE();
  };
  ...
  TaggedInput.prototype.readTaggedChar_11rb$ = function (tag) {
    var tmp$;
    return unboxChar(Kotlin.isChar(tmp$ = this.readTaggedValue_11rb$(tag)) ? tmp$ : Kotlin.throwCCE());
  };
  TaggedInput.prototype.readTaggedString_11rb$ = function (tag) {
    var tmp$;
    return typeof (tmp$ = this.readTaggedValue_11rb$(tag)) === 'string' ? tmp$ : Kotlin.throwCCE();
  };
  TaggedInput.prototype.readTaggedEnum_bu9nms$ = function (tag, enumClass) {
    var tmp$;
    return Kotlin.isType(tmp$ = this.readTaggedValue_11rb$(tag), Enum) ? tmp$ : Kotlin.throwCCE();
  };
  ...
  TaggedInput.prototype.readSerializableElementValue_ovkjkf$ = function (desc, index, loader) {
    this.pushTag_ffahlk$_0(this.getTag_fr5t0y$(desc, index));
    var r = this.readSerializableValue_2wvhm6$(loader);
  ...
  TaggedInput.prototype.readNullableSerializableElementValue_3ohjxu$ = function (desc, index, loader) {
    this.pushTag_ffahlk$_0(this.getTag_fr5t0y$(desc, index));
    var r = this.readNullableSerializableValue_xg8iph$(loader);
    if (!this.flag_expvl5$_0) {
      this.popTag_c7udbg$_0();
      this.flag_expvl5$_0 = false;
    }
  ...
  Mapper$InNullableMapper.prototype.readTaggedValue_11rb$ = function (tag) {
    var tmp$;
    return (tmp$ = getValue(this.map, tag)) != null ? tmp$ : Kotlin.throwNPE();
  };
  ...
  Mapper.prototype.map_issdgt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.Mapper.map_issdgt$', wrapFunction(function () {
    ...
    return function (T_0, isT, obj) {
      ...
      m.write_jsy488$(serializer(Kotlin.getKClass(T_0)), obj);
      return m.map;
    };
  }));
  ...
  Mapper.prototype.unmap_67iyj5$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.Mapper.unmap_67iyj5$', wrapFunction(function () {
    ...
    return function (T_0, isT, map) {
      ...
      return m.read_2wvhm6$(serializer(Kotlin.getKClass(T_0)));
    };
  }));
  ...
  CBOR$CBORListWriter.prototype.writeElement_xvmgof$ = function (desc, index) {
    return !Kotlin.equals(desc.getElementName_za3lpa$(index), 'size');
  };
  ...
  CBOR$CBORWriter.prototype.writeBegin_276rha$ = function (desc, typeParams) {
    var tmp$, tmp$_0;
    tmp$ = desc.kind;
    if (Kotlin.equals(tmp$, KSerialClassKind$LIST_getInstance()) || Kotlin.equals(tmp$, KSerialClassKind$SET_getInstance()))
  ...
  CBOR$CBOREncoder.prototype.encodeFloat_mx4ult$ = function (value) {
    var data = ByteBuffer$Companion_getInstance().allocate_za3lpa$(5).put_s8j3t7$(Kotlin.toByte(CBOR$Companion_getInstance().NEXT_FLOAT_0)).putFloat_mx4ult$(value).array();
    this.output.write_fqrh44$(data);
  };
  CBOR$CBOREncoder.prototype.encodeDouble_14dthe$ = function (value) {
    var data = ByteBuffer$Companion_getInstance().allocate_za3lpa$(9).put_s8j3t7$(Kotlin.toByte(CBOR$Companion_getInstance().NEXT_DOUBLE_0)).putDouble_14dthe$(value).array();
    this.output.write_fqrh44$(data);
  };
  ...
  CBOR$CBOREncoder.prototype.composePositive_0 = function (value) {
    if (contains(new IntRange(0, 23), value))
      return new Int8Array([Kotlin.toByte(value.toInt())]);
    else if (contains(new IntRange(24, ByteCompanionObject.MAX_VALUE), value))
      return new Int8Array([24, Kotlin.toByte(value.toInt())]);
    else if (contains(new IntRange(ByteCompanionObject.MAX_VALUE + 1, ShortCompanionObject.MAX_VALUE), value))
      return ByteBuffer$Companion_getInstance().allocate_za3lpa$(3).put_s8j3t7$(Kotlin.toByte(25)).putShort_mq22fl$(Kotlin.toShort(value.toInt())).array();
    else if (contains(new IntRange(ShortCompanionObject.MAX_VALUE + 1, IntCompanionObject.MAX_VALUE), value))
      return ByteBuffer$Companion_getInstance().allocate_za3lpa$(5).put_s8j3t7$(Kotlin.toByte(26)).putInt_za3lpa$(value.toInt()).array();
    else if ((new Kotlin.Long(-2147483648, 0)).rangeTo(new Kotlin.Long(-1, 2147483647)).contains_mef7kx$(value))
      return ByteBuffer$Companion_getInstance().allocate_za3lpa$(9).put_s8j3t7$(Kotlin.toByte(27)).putLong_s8cxhz$(value).array();
    else
      throw new IllegalArgumentException();
  };
  CBOR$CBOREncoder.prototype.composeNegative_0 = function (value) {
    var aVal = Kotlin.equals(value, new Kotlin.Long(0, -2147483648)) ? new Kotlin.Long(-1, 2147483647) : Kotlin.Long.fromInt(-1).subtract(value);
  ...
  CBOR$CBORReader.prototype.readByteValue = function () {
    return Kotlin.toByte(this.decoder.nextNumber().toInt());
  };
  CBOR$CBORReader.prototype.readShortValue = function () {
    return Kotlin.toShort(this.decoder.nextNumber().toInt());
  };
  CBOR$CBORReader.prototype.readCharValue = function () {
    return Kotlin.toChar(this.decoder.nextNumber().toInt());
  };
  ...
  CBOR$Companion.prototype.dump_issdgt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.cbor.CBOR.Companion.dump_issdgt$', wrapFunction(function () {
    ...
    return function (T_0, isT, obj) {
      var $this = this.plain;
      return $this.dump_20fw5n$(klassSerializer($this.context, Kotlin.getKClass(T_0)), obj);
    };
  }));
  CBOR$Companion.prototype.dumps_issdgt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.cbor.CBOR.Companion.dumps_issdgt$', wrapFunction(function () {
    ...
    return function (T_0, isT, obj) {
      var $this = this.plain;
      return internal.HexConverter.printHexBinary_1fhb37$($this.dump_20fw5n$(klassSerializer($this.context, Kotlin.getKClass(T_0)), obj), true);
    };
  }));
  CBOR$Companion.prototype.load_crzfsd$ = function (loader, raw) {
    return this.plain.load_crzfsd$(loader, raw);
  };
  CBOR$Companion.prototype.load_5geitx$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.cbor.CBOR.Companion.load_5geitx$', wrapFunction(function () {
    ...
    return function (T_0, isT, raw) {
      var $this = this.plain;
      return $this.load_crzfsd$(klassSerializer($this.context, Kotlin.getKClass(T_0)), raw);
    };
  }));
  ...
  CharSerializer.prototype.load_ljkqvg$ = function (input) {
    return toBoxedChar(input.readCharValue());
  };
  ...
  function LinkedHashMapSerializer(kSerializer, vSerializer) {
    ListLikeSerializer.call(this, new MapEntrySerializer(kSerializer, vSerializer));
  ...
  function MapEntrySerializer(kSerializer, vSerializer) {
    this.kSerializer_0 = kSerializer;
    this.vSerializer_0 = vSerializer;
  ...
  MapEntrySerializer.prototype.save_ejfkry$ = function (output, obj) {
    var output_0 = output.writeBegin_276rha$(MapEntryClassDesc_getInstance(), [this.kSerializer_0, this.vSerializer_0]);
    output_0.writeSerializableElementValue_k4al2t$(MapEntryClassDesc_getInstance(), KEY_INDEX, this.kSerializer_0, obj.key);
    output_0.writeSerializableElementValue_k4al2t$(MapEntryClassDesc_getInstance(), VALUE_INDEX, this.vSerializer_0, obj.value);
    output_0.writeEnd_f6e2p$(MapEntryClassDesc_getInstance());
  };
  MapEntrySerializer.prototype.load_ljkqvg$ = function (input) {
    var tmp$, tmp$_0, tmp$_1;
    var input_0 = input.readBegin_276rha$(MapEntryClassDesc_getInstance(), [this.kSerializer_0, this.vSerializer_0]);
    var kSet = false;
    var vSet = false;
    var k = null;
    var v = null;
    mainLoop: while (true) {
      tmp$ = input_0.readElement_f6e2p$(MapEntryClassDesc_getInstance());
      if (tmp$ === KInput$Companion_getInstance().READ_ALL) {
        k = input_0.readSerializableElementValue_ovkjkf$(MapEntryClassDesc_getInstance(), KEY_INDEX, this.kSerializer_0);
        kSet = true;
        v = input_0.readSerializableElementValue_ovkjkf$(MapEntryClassDesc_getInstance(), VALUE_INDEX, this.vSerializer_0);
        vSet = true;
        break mainLoop;
      }
    ...
    input_0.readEnd_f6e2p$(MapEntryClassDesc_getInstance());
    if (!kSet)
      throw new SerializationException('Required key is missing');
    if (!vSet)
      throw new SerializationException('Required value is missing');
    return new MapEntry((tmp$_0 = k) == null || Kotlin.isType(tmp$_0, Any) ? tmp$_0 : Kotlin.throwCCE(), (tmp$_1 = v) == null || Kotlin.isType(tmp$_1, Any) ? tmp$_1 : Kotlin.throwCCE());
  };
  ...
  HexConverter.prototype.parseHexBinary_61zpoe$ = function (s) {
    ...
    while (i < len) {
      ...
      out[i / 2 | 0] = Kotlin.toByte((h * 16 | 0) + l | 0);
      i = i + 2 | 0;
    }
    return out;
  };
  ...
  function ProtoNumberType$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant kotlinx.serialization.protobuf.ProtoNumberType.' + name);
    }
  }
  ...
  ProtoBuf$ProtobufWriter.prototype.writeBegin_276rha$ = function (desc, typeParams) {
    var tmp$;
    tmp$ = desc.kind;
    if (Kotlin.equals(tmp$, KSerialClassKind$LIST_getInstance()) || Kotlin.equals(tmp$, KSerialClassKind$MAP_getInstance()) || Kotlin.equals(tmp$, KSerialClassKind$SET_getInstance()))
      return new ProtoBuf$RepeatedWriter(this.$outer, this.encoder, this.currentTag);
    else if (Kotlin.equals(tmp$, KSerialClassKind$CLASS_getInstance()) || Kotlin.equals(tmp$, KSerialClassKind$OBJECT_getInstance()) || Kotlin.equals(tmp$, KSerialClassKind$SEALED_getInstance()) || Kotlin.equals(tmp$, KSerialClassKind$POLYMORPHIC_getInstance()))
  ...
  ProtoBuf$ProtobufEncoder.prototype.encode32_0 = function (number, format) {
    ...
    if (Kotlin.equals(format, ProtoNumberType$FIXED_getInstance()))
    ...
    else if (Kotlin.equals(format, ProtoNumberType$DEFAULT_getInstance()))
      return ProtoBuf$Varint_getInstance().encodeVarint_8e33dg$(Kotlin.Long.fromInt(number));
    else if (Kotlin.equals(format, ProtoNumberType$SIGNED_getInstance()))
  ...
  ProtoBuf$ProtobufReader.prototype.readTaggedByte_11rb$ = function (tag) {
    return Kotlin.toByte(this.decoder.nextInt_bmwen1$(tag.second));
  };
  ProtoBuf$ProtobufReader.prototype.readTaggedShort_11rb$ = function (tag) {
    return Kotlin.toShort(this.decoder.nextInt_bmwen1$(tag.second));
  };
  ...
  ProtoBuf$ProtobufReader.prototype.readTaggedChar_11rb$ = function (tag) {
    return Kotlin.toChar(this.decoder.nextInt_bmwen1$(tag.second));
  };
  ...
  ProtoBuf$ProtobufDecoder.prototype.decode32_0 = function (format, eofAllowed) {
    ...
    if (eofAllowed === void 0)
      eofAllowed = false;
    if (Kotlin.equals(format, ProtoNumberType$DEFAULT_getInstance()))
    ...
    else if (Kotlin.equals(format, ProtoNumberType$FIXED_getInstance()))
  ...
  ProtoBuf$Varint.prototype.encodeVarint_kcn2v3$ = function (inp) {
    ...
    while ((value & (new Kotlin.Long(-128, 0)).toInt()) !== 0) {
      byteArrayList[tmp$ = i, i = tmp$ + 1 | 0, tmp$] = Kotlin.toByte(value & 127 | 128);
      value = value >>> 7;
    }
    byteArrayList[i] = Kotlin.toByte(value & 127);
  ...
  ProtoBuf$Varint.prototype.encodeVarint_8e33dg$ = function (inp) {
    ...
    var byteArrayList = new Int8Array(10);
    var i = 0;
    while (!Kotlin.equals(value.and(new Kotlin.Long(-128, 0)), Kotlin.Long.ZERO)) {
      byteArrayList[tmp$ = i, i = tmp$ + 1 | 0, tmp$] = Kotlin.toByte(value.and(Kotlin.Long.fromInt(127)).or(Kotlin.Long.fromInt(128)).toInt());
      value = value.shiftRightUnsigned(7);
    }
    byteArrayList[i] = Kotlin.toByte(value.and(Kotlin.Long.fromInt(127)).toInt());
    var out = new Int8Array(i + 1 | 0);
    while (i >= 0) {
      out[i] = byteArrayList[i];
      i = i - 1 | 0;
  ...
  ProtoBuf$Companion.prototype.load_crzfsd$ = function (loader, raw) {
    return this.plain.load_crzfsd$(loader, raw);
  };
  ...
  ProtoBuf.prototype.load_crzfsd$ = function (loader, raw) {
    var stream = ByteArrayInputStream_init(raw);
  ...
  ByteBuffer.prototype.getChar_za3lpa$ = function (index) {
    ...
    return Kotlin.toChar(this.dw_0.getUint16(i, this.order === ByteOrder$LITTLE_ENDIAN_getInstance()));
  };
  ...
  ByteBuffer.prototype.putChar_s9u7hn$ = function (value, index) {
    var i = this.idx_0(index, 2);
    this.dw_0.setUint16(i, Kotlin.toShort(value | 0), this.order === ByteOrder$LITTLE_ENDIAN_getInstance());
    return this;
  };
  ...
  ByteArrayOutputStream.prototype.write_za3lpa$ = function (oneByte) {
    ...
    this.buf_0[tmp$ = this.count_0, this.count_0 = tmp$ + 1 | 0, tmp$] = Kotlin.toByte(oneByte);
  };
  ...
  function toUtf8Bytes($receiver) {
    ...
    var $receiver_0 = toList_0(typeof (tmp$ = blck) === 'string' ? tmp$ : Kotlin.throwCCE());
    var destination = ArrayList_init(collectionSizeOrDefault($receiver_0, 10));
    var tmp$_0;
    tmp$_0 = $receiver_0.iterator();
    while (tmp$_0.hasNext()) {
      var item = tmp$_0.next();
      destination.add_11rb$(Kotlin.toByte(unboxChar(item) | 0));
    }
  ...
  function stringFromUtf8Bytes(bytes) {
    ...
    for (tmp$_0 = 0; tmp$_0 !== bytes.length; ++tmp$_0) {
      ...
      destination.add_11rb$(toBoxedChar(Kotlin.toChar(item & 255)));
    }
    var s = joinToString(destination, '');
    var ans = decodeURIComponent(escape(s));
    return typeof (tmp$ = ans) === 'string' ? tmp$ : Kotlin.throwCCE();
  }
  ...
  function enumFromOrdinal(enumClass, ordinal) {
    var tmp$;
    return (Kotlin.isArray(tmp$ = get_js(enumClass).values()) ? tmp$ : Kotlin.throwCCE())[ordinal];
  }
