(function (_, Kotlin, $module$kotlinx_serialization_runtime_js) {
  ...
  function compareTo($receiver, otherDate) {
    return numberToLong($receiver.getTime()).compareTo_11rb$(numberToLong(otherDate.getTime()));
  }
  ...
  SessionModel$Companion.$metadata$ = {
    kind: Kind_OBJECT,
  ...
  SessionModel.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'SessionModel',
    interfaces: []
  };
  ...
  Object.defineProperty(AllData$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  function SessionizeData(allData, etag) {
    if (etag === void 0)
      etag = allData.hashCode().toString();
    this.allData = allData;
    this.etag = etag;
  }
  SessionizeData.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'SessionizeData',
    interfaces: []
  };
  ...
  Object.defineProperty(Category$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  Object.defineProperty(CategoryItem$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  CategoryItem$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: [KSerializer]
  };
  ...
  CategoryItem.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'CategoryItem',
    interfaces: []
  };
  ...
  Object.defineProperty(Favorite$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  Object.defineProperty(Link$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  Object.defineProperty(Question$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  Object.defineProperty(QuestionAnswer$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  QuestionAnswer$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: [KSerializer]
  };
  ...
  QuestionAnswer.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'QuestionAnswer',
    interfaces: []
  };
  ...
  Object.defineProperty(Room$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  Object.defineProperty(Session$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  function SessionGroup(groupName, sessions, groupId) {
    SessionGroup$Companion_getInstance();
    if (groupName === void 0)
      groupName = null;
    if (sessions === void 0)
      sessions = null;
  ...
  function SessionGroup$Companion() {
    this.serialClassDesc_1vydqo$_0 = new SerialClassDescImpl('com.fans.kotlinconf.data.SessionGroup');
    this.serialClassDesc.addElement_61zpoe$('groupName');
    this.serialClassDesc.addElement_61zpoe$('sessions');
    this.serialClassDesc.addElement_61zpoe$('groupId');
    SessionGroup$Companion_instance = this;
  }
  Object.defineProperty(SessionGroup$Companion.prototype, 'serialClassDesc', {
    get: function () {
      return this.serialClassDesc_1vydqo$_0;
    }
  });
  SessionGroup$Companion.prototype.save_ejfkry$ = function (output_0, obj) {
    var output = output_0.writeBegin_276rha$(this.serialClassDesc, []);
    output.writeNullableSerializableElementValue_874a36$(this.serialClassDesc, 0, $module$kotlinx_serialization_runtime_js.kotlinx.serialization.internal.StringSerializer, obj.groupName);
    output.writeNullableSerializableElementValue_874a36$(this.serialClassDesc, 1, new $module$kotlinx_serialization_runtime_js.kotlinx.serialization.internal.ArrayListSerializer(new $module$kotlinx_serialization_runtime_js.kotlinx.serialization.internal.NullableSerializer(_.com.fans.kotlinconf.data.Session.Companion)), obj.sessions);
    output.writeNullableSerializableElementValue_874a36$(this.serialClassDesc, 2, $module$kotlinx_serialization_runtime_js.kotlinx.serialization.internal.IntSerializer, obj.groupId);
    output.writeEnd_f6e2p$(this.serialClassDesc);
  };
  SessionGroup$Companion.prototype.load_ljkqvg$ = function (input_0) {
    var index, readAll = false;
    var bitMask0 = 0;
    var groupName
    , sessions
    ...
    loopLabel: while (true) {
      ...
      switch (index) {
        case -2:
          readAll = true;
        case 0:
          groupName = input.readNullableSerializableElementValue_3ohjxu$(this.serialClassDesc, 0, $module$kotlinx_serialization_runtime_js.kotlinx.serialization.internal.StringSerializer);
          bitMask0 |= 1;
          if (!readAll)
            break;
        case 1:
          sessions = input.readNullableSerializableElementValue_3ohjxu$(this.serialClassDesc, 1, new $module$kotlinx_serialization_runtime_js.kotlinx.serialization.internal.ArrayListSerializer(new $module$kotlinx_serialization_runtime_js.kotlinx.serialization.internal.NullableSerializer(_.com.fans.kotlinconf.data.Session.Companion)));
          bitMask0 |= 2;
          if (!readAll)
            break;
        case 2:
          groupId = input.readNullableSerializableElementValue_3ohjxu$(this.serialClassDesc, 2, $module$kotlinx_serialization_runtime_js.kotlinx.serialization.internal.IntSerializer);
          bitMask0 |= 4;
          if (!readAll)
            break;
        case -1:
    ...
    input.readEnd_f6e2p$(this.serialClassDesc);
    return SessionGroup_init(bitMask0, groupName, sessions, groupId, null);
  };
  SessionGroup$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: [KSerializer]
  };
  var SessionGroup$Companion_instance = null;
  function SessionGroup$Companion_getInstance() {
    if (SessionGroup$Companion_instance === null) {
      new SessionGroup$Companion();
    }
    return SessionGroup$Companion_instance;
  }
  function SessionGroup_init(seen, groupName, sessions, groupId, serializationConstructorMarker) {
    var $this = Object.create(_.com.fans.kotlinconf.data.SessionGroup.prototype);
    if ((seen & 1) === 0)
      throw new $module$kotlinx_serialization_runtime_js.kotlinx.serialization.MissingFieldException('groupName');
    else
      $this.groupName = groupName;
    if ((seen & 2) === 0)
      throw new $module$kotlinx_serialization_runtime_js.kotlinx.serialization.MissingFieldException('sessions');
      ...
      $this.sessions = sessions;
    if ((seen & 4) === 0)
      throw new $module$kotlinx_serialization_runtime_js.kotlinx.serialization.MissingFieldException('groupId');
    else
      $this.groupId = groupId;
    return $this;
  }
  SessionGroup.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'SessionGroup',
    interfaces: []
  };
  SessionGroup.prototype.component1 = function () {
    return this.groupName;
  };
  SessionGroup.prototype.component2 = function () {
    return this.sessions;
  };
  SessionGroup.prototype.component3 = function () {
    return this.groupId;
  };
  SessionGroup.prototype.copy_9ogjxr$ = function (groupName, sessions, groupId) {
    return new SessionGroup(groupName === void 0 ? this.groupName : groupName, sessions === void 0 ? this.sessions : sessions, groupId === void 0 ? this.groupId : groupId);
  };
  SessionGroup.prototype.toString = function () {
    return 'SessionGroup(groupName=' + Kotlin.toString(this.groupName) + (', sessions=' + Kotlin.toString(this.sessions)) + (', groupId=' + Kotlin.toString(this.groupId)) + ')';
  };
  SessionGroup.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.groupName) | 0;
    result = result * 31 + Kotlin.hashCode(this.sessions) | 0;
    result = result * 31 + Kotlin.hashCode(this.groupId) | 0;
    return result;
  };
  SessionGroup.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.groupName, other.groupName) && Kotlin.equals(this.sessions, other.sessions) && Kotlin.equals(this.groupId, other.groupId)))));
  };
  ...
  Object.defineProperty(Speaker$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  Object.defineProperty(Vote$Companion.prototype, 'serialClassDesc', {
    get: function () {
  ...
  package$kotlinconf.compareTo_hqsxrj$ = compareTo;
  ...
  Object.defineProperty(SessionModel, 'Companion', {
    get: SessionModel$Companion_getInstance
  });
  package$kotlinconf.SessionModel = SessionModel;
  Object.defineProperty(AllData, 'Companion', {
    get: AllData$Companion_getInstance
  });
  var package$data = package$kotlinconf.data || (package$kotlinconf.data = {});
  package$data.AllData = AllData;
  package$data.SessionizeData = SessionizeData;
  Object.defineProperty(Category, 'Companion', {
    get: Category$Companion_getInstance
  });
  package$data.Category = Category;
  Object.defineProperty(CategoryItem, 'Companion', {
    get: CategoryItem$Companion_getInstance
  });
  package$data.CategoryItem = CategoryItem;
  Object.defineProperty(Favorite, 'Companion', {
    get: Favorite$Companion_getInstance
  });
  ...
  Object.defineProperty(Question, 'Companion', {
    get: Question$Companion_getInstance
  });
  package$data.Question = Question;
  Object.defineProperty(QuestionAnswer, 'Companion', {
    get: QuestionAnswer$Companion_getInstance
  });
  package$data.QuestionAnswer = QuestionAnswer;
  Object.defineProperty(Room, 'Companion', {
    get: Room$Companion_getInstance
  });
  ...
  Object.defineProperty(SessionGroup, 'Companion', {
    get: SessionGroup$Companion_getInstance
  });
  package$data.SessionGroup = SessionGroup;
  Object.defineProperty(Speaker, 'Companion', {
    get: Speaker$Companion_getInstance
  });
  package$data.Speaker = Speaker;
  Object.defineProperty(Vote, 'Companion', {
    get: Vote$Companion_getInstance
  });
